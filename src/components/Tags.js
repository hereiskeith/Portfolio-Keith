...
const Tags = (props) => {
  useEffect(() => {
    ...
    iconElements.forEach((icon) => {
      icon.addEventListener(
        "mouseover",
        (e) => (e.target.style.color = "#268FA5"),
        false
      );
      icon.addEventListener(
        "mouseout",
        (e) => (e.target.style.color = ""),
        false
      );
    });
  }, []);
  ...
  const Icon = (Components, className) => {
    return <Components className={className} />;
  };
  ...
  return (
    <div className={"tags " + props.className}>
      <a
        id="linkedin-icon"
        href="https://www.linkedin.com/in/keithli93/"
        target="_blank"
      ...
      <a
        id="github-icon"
        href="https://github.com/hereiskeith"
        target="_blank"
        rel="noreferrer noopener"
      >
      ...
      <a
        id="facebook-icon"
        href="https://www.facebook.com/keithli1993"
        target="_blank"
        rel="noreferrer noopener"
      >
